/********index**************************************/
function index_f1 () {
    $("#js_sl span:eq(0)").css("backgroundImage","url(images/rt_btn_pressed.png)");
    $("#js_sl input:eq(0)").prop('chesked',true);
    $("#js_sl span").click(function () {
        $("#js_sl span").css("backgroundImage","url(images/rt_btn_default.png)");
        $("#js_sl input").prop('checked',false);
        var num= $(this).index();
        $("#js_sl input:eq("+num+")").prop('chesked',true);
        $(this).css("backgroundImage","url(images/rt_btn_pressed.png)");
...
function index_f2(){
    ...
    $('.dress').on('click',function(){
        ...
        for(let j=0;j<arr2[0].length;j++){
            $('.dropCityUl').append("<li class='dropCityLi'>"+arr2[0][j]+"</li>");
...
function my_teamf1() {
    ...
    $("#baocun").click(function () {
        var name= $("#title_6").val();
        var numb= $("#title_7").val();
        $(" <li class='new_show'><spanc class=\"span_name\">"+name+"</spanc><span class=\"span_number\" >"+numb+"</span><span><a class=\"span_delet\" href=\"\">删除</a></span></li>").appendTo($(".yijia ul"));
        $("#title_6").val("");
        $("#title_7").val("");
        $("#zhe").hide();
        $("#tian").hide();
    ...
    $(".new_show").on("click",".span_delet",function () {
        $(this).parent().remove;
        return false;
    });
}